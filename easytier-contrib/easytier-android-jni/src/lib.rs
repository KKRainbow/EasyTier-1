...
///
/// Java signature:
/// `EasyTierJNI.collectNetworkInfos(): String?`
///
/// Returns a JSON string containing `NetworkInstanceRunningInfoMap`, or null if
/// collection fails. On failure this throws `RuntimeException` when an error
...
pub extern "system" fn Java_com_easytier_jni_EasyTierJNI_collectNetworkInfos(
    ...
    logger::init();
    network_api::collect_network_infos_jni(env, class)
}
